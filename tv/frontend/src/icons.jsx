...
export function IconWifi({ size = 14 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 14 14" fill="none">
      <path d="M1.5 5.5C3.7 3.4 6.2 2.5 7 2.5s3.3.9 5.5 3" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
      <path d="M3.5 7.5C4.8 6.3 5.9 5.7 7 5.7s2.2.6 3.5 1.8" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/>
...
export function IconBattery({ size = 16 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 16 10" fill="none">
      ...
      <rect x="2" y="2" width="8" height="6" rx="0.8" fill="currentColor" opacity="0.6"/>
    </svg>
  )
}
